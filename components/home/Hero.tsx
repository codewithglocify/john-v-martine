...
export default function Hero() {
  return (
    <div className="w-full overflow-hidden">
      <HeroBackground />
      <div className="relative z-10 w-full max-w-[1240px] mx-auto px-4 sm:px-6 md:px-8 flex flex-col items-center justify-center py-20 min-[640px]:pt-10 min-[640px]:pb-0">
        <div className="w-full grid grid-cols-1 min-[640px]:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center">
          <div className="w-full sm:w-[700px] flex flex-col justify-center items-start gap-6 sm:gap-5 md:gap-5 lg:gap-20 pt-0 sm:pt-2 md:pt-2 lg:pt-0">
            <div className="w-full max-w-full min-[640px]:max-w-[420px] md:max-w-[540px] lg:max-w-[650px] xl:max-w-[807px] flex flex-col justify-start items-start gap-2 sm:gap-3 md:gap-4 lg:gap-5">
              ...
              <p className="text-sm sm:text-sm md:text-base lg:text-lg text-zinc-100 w-full max-w-full min-[640px]:max-w-[360px] md:max-w-[460px] lg:max-w-[560px] xl:max-w-[707px] leading-relaxed">
            ...
            <div className="w-full flex flex-col justify-start items-start gap-3 sm:gap-4 md:gap-5 mt-2 sm:mt-0">
              ...
              <div className="flex items-center gap-3">
                <div className="flex -space-x-2">
                  {[
                    { src: '/images/home/client1.svg', alt: 'Client 1' },
                    { src: '/images/home/client2.svg', alt: 'Client 2' },
                    { src: '/images/home/client3.svg', alt: 'Client 3' },
                  ].map((client) => (
                    <Image
                      key={client.src}
                      src={client.src}
